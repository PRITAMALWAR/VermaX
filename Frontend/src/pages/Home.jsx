...
const Home = () => {
  ...
  useEffect(() => {
    // Get one product from each category, limit to 8
    ...
    for (const product of productsData.products) {
      ...
      if (uniqueCategoryProducts.length === 8) break;
    }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl mb-8 text-gray-200 leading-relaxed">
                ...
                to fashion, we have everything you need to upgrade your lifestyle.
              </p>
            ...
            >
              <img
                ...
                className="rounded-lg shadow-2xl w-full h-80 object-cover block"
              />
            </motion.div>
          </div>
        </div>
...
//   useEffect(() => {
//     // Get first 8 products as featured
//     setFeaturedProducts(productsData.products.slice(0, 12));
//   }, []);
